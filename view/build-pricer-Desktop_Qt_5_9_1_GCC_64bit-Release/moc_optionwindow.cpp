...
#include "../options/optionwindow.h"
...
QT_MOC_LITERAL(1, 13, 12), // "optionPriced"
QT_MOC_LITERAL(2, 26, 0), // ""
QT_MOC_LITERAL(3, 27, 11) // "priceOption"

    },
    "OptionWindow\0optionPriced\0\0priceOption"
};
...
void OptionWindow::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->optionPriced((*reinterpret_cast< double(*)>(_a[1]))); break;
        case 1: _t->priceOption(); break;
        default: ;
        }
        ...
        {
            typedef void (OptionWindow::*_t)(double );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&OptionWindow::optionPriced)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void OptionWindow::optionPriced(double _t1)
{
